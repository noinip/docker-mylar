...
I've also added ComicTagger HOLLA!  
It's in the same place as where mylar is installed so it should just work if you enable tagging in the config. If you have to put in the directory it's at /opt/mylar. Technically I check it out to /opt/comictagger and then cop it to mylar. Works For Me (tm)
